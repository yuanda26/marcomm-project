...
module.exports = (server) => {
	...
	server.get('/api/company/:companyId', authenticate, companyLogic.readCompanyByID);
	server.post('/api/company', authenticate, companyLogic.createCompany);
	server.put('/api/company/:companyId', authenticate, companyLogic.updateCompany);
	server.del('/api/company/:companyId', authenticate, companyLogic.deleteCompany);
	//== End of Company Route

	// Master Role Route
	// Made By: Randika Alditia
	server.get('/api/role', roleLogic.readAllRole);
	...
	server.get('/api/souvenir/:souvenirId', authenticate, souvenirLogic.readSouvenirById);
	server.post('/api/souvenir', authenticate, souvenirLogic.createSouvenir);
	server.put('/api/souvenir/:souvenirId', authenticate, souvenirLogic.updateSouvenir);
	...
	server.put('/api/design/:code', authenticate, tDesignLogic.updateDesignHandler);
	server.put('/api/design/approve/:code', authenticate, tDesignLogic.approveHandler);
	server.put('/api/design/close/:code', authenticate, tDesignLogic.closeReqHandler);
	server.post('/api/design/upload_files', authenticate, tDesignLogic.createDesignItemFile);
	server.get('/api/design/files/:itemId', authenticate, tDesignLogic.getDesignFiles);
	...
	// Made By: Dian Yuanda
	server.get('/api/design/item/:code', authenticate, tDesignItemLogic.readAllItemHandler);
	server.post('/api/design/item', authenticate, tDesignItemLogic.createItemHandler);
	server.put('/api/design/item', authenticate, tDesignItemLogic.updateItemHandler);
	server.del('/api/design/item/:itemId', authenticate, tDesignItemLogic.deleteItemHandler);
	...
	server.get('/api/tsouvenir/:souvenirId', authenticate, tSouvenirLogic.readByIdHandler);
	server.post('/api/tsouvenir', authenticate, tSouvenirLogic.createHandlerItem);
	server.put('/api/tsouvenir/:souvenirId', authenticate, tSouvenirLogic.updateHandler);
	...
	server.get('/api/tsouveniritemdetil', authenticate, tSouvenirItemLogic.readSouvenirItemAllHandler);
	server.get('/api/tsouveniritem/:souvenirId', authenticate, tSouvenirItemLogic.readByIdHandler);
	...
	server.put('/api/tsouveniritem/adminrequestapprove/:souvenirId', authenticate, tSouvenirItemLogic.approveHandler);
	server.put('/api/tsouveniritem/adminrequestreject/:souvenirId', authenticate, tSouvenirItemLogic.rejectHandler);

	server.put('/api/tsouveniritem/receivedsouvenir/:souvenirId', authenticate, tSouvenirItemLogic.receivedHandler);
	...
	server.put('/api/tsouveniritem/colseorder/:souvenirId', authenticate, tSouvenirItemLogic.closeOrderHandler);
	...
	//edited by: randika alditia
	server.get('/api/promotion_item/:code/:designCode', authenticate, promotionLogic.readByPromotionID);
	...
	server.post('/api/promotion_design', authenticate, promotionLogic.handlerAddWithDesign);
};
