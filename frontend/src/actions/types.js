...
export const GET_DESIGN_FILE = "GET_DESIGN_FILE";
export const GET_ITEM = "GET_ITEM";
export const ADD_DESIGN_ITEM = "ADD_DESIGN_ITEM";
export const UPDATE_DESIGN_ITEM = "UPDATE_DESIGN_ITEM";
export const DELETE_ITEM = "DELETE_ITEM";
export const ADD_FILE = "ADD_FILE";
export const UPDATE_FILE = "UPDATE_FILE";
export const DELETE_FILE = "DELETE_FILE";

// Approve Transaction Design
...
export const GET_SOUVENIR = "GET_SOUVENIR";
