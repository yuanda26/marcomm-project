...
import { uploadDesign } from "../../../actions/designAction";
...
class addPromotionD extends React.Component {
    ...
    submitHandler = () => {
        ...
        if (this.state.marketHeader.title !== "" && lala.length > 0) {
            ...
            data.file.forEach(content => {
                formdata.append("uploads", content.uploads);
            });
