...
import { getAllPromotion, putPromotion } from '../../../actions/promotionActions';
...
export default connect(mapStateToProps, { getAllPromotion, getFile, putPromotion })(addPromotionD);
